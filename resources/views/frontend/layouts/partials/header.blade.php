    ...
    <div class="container">
      <div class="dropdown float-right">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          @if(Auth::check())
          <a class="dropdown-item" href="{{route('users.profile', Auth::user()->user_name)}}">Profile</a>
          <a class="dropdown-item" href="{{route('users.dashboards')}}">Dashboard</a>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          ...
          <form class="form-inline my-2 my-lg-0" action="{{route('books.search')}}" method="get">
            @csrf
            <input class="form-control mr-sm-2 search-form" type="text" name="search" value="{{isset($search) ? $search : ''}}" placeholder="Search" aria-label="Search">
